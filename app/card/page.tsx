...
function ThreeDCardDemo() {
  return (
      ...
      <CardBody className=" relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] bg-black bg-opacity-85  dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border  ">
        <CardItem translateZ="60" className="w-full rounded-md mt-4">
            <div className="banner">
                <Image
                src={'https://i.pinimg.com/originals/6b/7f/b0/6b7fb07e489df83953b5d933fa686f58.jpg'}
                width={960}
                height={240}
                alt="Banner"
          ...
          <Image
            src="https://i.pinimg.com/originals/21/89/64/2189646bb6eca008733096d13c0c94d3.jpg"
            height="108"
            width="108"
    ...
    <div className="flex items-center">
        <a className="font-semibold text-2xl">nd</a>
    </div>
...
vn / 14</p>
    ...
    <a href="https://github.com/l2md3v" target="blank">
    ...
    <a href="https://discordapp.com/users/986191703536984064" target="blank">
        <div className="connection mt-2 bg-neutral-950 bg-opacity-70 rounded-md py-2.5 px-4 flex items-center gap-2 w-full">
